...
import {Checkbox, CheckboxAppearances, CheckboxLabelPositions, CheckboxProps, CheckboxSizes} from "@app/Atoms";
...
const meta = {
    ...
    argTypes: {
        ...
        label: {
            ...
            description: "If passed, the text or jsx element to be displayed as the input label",
        },
        labelPosition: {
        ...
        onChange: {
            ...
            description: "If passed, triggers when the value of the Checkbox changes. Receives the updated value as a parameter",
        },
        appearance: {
...
export const Default: Story = {
    decorators: [
        (Story) => {
            const {props} = Story();
            return (
                <CheckboxStoriesWrapper withBackground={props.appearance === CheckboxAppearances.LIGHT}>
                    <Story />
...
export const ControlledComponent: Story = {
    render: (args) => {
        ...
        return (
            <CheckboxStoriesWrapper withBackground={args.appearance === CheckboxAppearances.LIGHT}>
                <Checkbox {...args} checked={isChecked} onChange={handleChange} data-testid="checkbox-controlled-component" />
...
export const withLeadingLabel: Story = {
    ...
    decorators: [
        (Story) => {
            const {props} = Story();
            return (
                <CheckboxStoriesWrapper withBackground={props.disableTransparency}>
                    <Story />
                </CheckboxStoriesWrapper>
            );
        },
