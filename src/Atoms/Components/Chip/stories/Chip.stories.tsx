...
import {Chip, ChipColors, ChipProps, ChipShapes, ChipSizes, ChipVariants} from "@app/Atoms";
...
const meta = {
    ...
    argTypes: {
        ...
        onClick: {
            description: "The action to be performed when the chip is clicked. If passed, the chip will be clickeable",
            control: {type: "boolean"},
            table: {
                type: {
                    summary: "function",
        ...
        leadingIcon: {
            ...
            description: "If passed, the icon will be shown on the left side of the chip",
        },
        leadingImg: {
            control: {type: "text"},
            table: {
            ...
            description: "Image SRC. If passed, the img will be shown on the left side of the chip",
        },
    },
    args: {
        label: "Chip",
...
export const Regular: Story = {
    decorators: [
        (Story) => {
            const {props} = Story();
            return (
                <ChipWrapper dark={props.color === ChipColors.WHITE}>
                    <Story
                        args={{...props, onClick: props?.onClick ? () => {} : undefined, onClear: props?.onClear ? () => {} : undefined}}
                    />
                </ChipWrapper>
            );
        },
            ...
            <ChipWrapper dark={args.color === ChipColors.WHITE}>
                {["chip1", "chip2", "chip3"].map((chip, index) => (
                    <Chip
                        ...
                        variant={selectedChips.includes(chip) ? ChipVariants.FILLED : ChipVariants.OUTLINED}
