...
const meta = {
  ...
  argTypes: {
    ...
    customAnchorClassName: {
      ...
      description:
        "Custom classname to be forwarded to the anchor wrapper element.",
    },
    customPopoverClassName: {
      ...
      description:
        "Custom classname to be forwarded to the popover wrapper element.",
    },
    ...
    disableMobileModalMode: {
      ...
      description:
        "Controls whether to disable the default feature of showing the popover as a modal in mobile devices",
    },
    onOpen: {
      table: {
        type: {
...
export const AsWebappMenu: Story = {
  args: {
    content: (
      <div
        style={{
