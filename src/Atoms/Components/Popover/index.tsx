...
import {className, conditionalClass, onKeyDownA11y, styleByKey, useOnClickOutside} from "@app/shared";

import useModalMode from "../Dropdown/hooks/useModalMode";
...
export const Popover = ({
    ...
    return (
        <div
            ref={popoverRef}
            className={className(styles.popoverWrapper, customAnchorClassName, conditionalClass([styles.opened, !!isOpenInnerState]))}
        >
            <div
