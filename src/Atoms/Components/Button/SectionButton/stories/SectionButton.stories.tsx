...
import {SectionButton, SectionButtonProps} from "@app/Atoms";
...
const meta = {
    title: "Atoms/Buttons/SectionButton",
...
} satisfies Meta<SectionButtonProps>;
...
export const Section: Story = {
    args: {
        label: "How to Redeem",
        leadingIcon: IconsNames.NO_EARN_TRANSACTIONS,
