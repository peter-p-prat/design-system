...
const meta = {
    ...
    argTypes: {
        ...
        appearance: {
            ...
            description: "The button appearance, between light and default. Only works for secondary and ghost variants",
        },
        isDisabled: {
            control: {
                type: "boolean",
        ...
        (Story) => {
            ...
            return (
                <ButtonBackgroundWrapper
                    isActive={(variant === ButtonVariants.OUTLINED || isGhost) && appearance === ButtonAppearances.LIGHT}
                >
                    <Story />
                </ButtonBackgroundWrapper>
            );
...
export const Secondary: Story = {
    ...
    decorators: [
        (Story) => {
            const {props} = Story();
            return (
                <ButtonBackgroundWrapper isActive={props.appearance === ButtonAppearances.LIGHT}>
                    <Story />
                </ButtonBackgroundWrapper>
            );
        },
