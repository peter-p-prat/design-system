...
import {IconsNames, TenantLogo, TenantLogoColor, TenantLogoSize, TenantLogoVariable, TenantSymbolPosition} from "@app/Foundations";
...
const DEFAULT_OPTIONS = {
    date: {label: "Date", options: DEFAULT_RADIO_OPTIONS, mode: DropdownCollapsibleOptionModes.RADIO},
    transactions: {label: "Transaction", options: DEFAULT_MULTISELECT_OPTIONS, mode: DropdownCollapsibleOptionModes.MULTI_SELECT},
};
...
export const UseAsControlledComponent: Story = {
    render: (args) => {
        const [dropdownValue, setDropdownValue] = useState<DropdownCollapsibleValue>();
        ...
        return (
            <DropdownWrapper withBackground={!isCustomTrigger(args.trigger) && args.trigger.disableTransparency} light={args.light}>
                <DropdownCollapsible {...args} value={dropdownValue} onChange={handleChange} />
...
export const WithSubmitActionButton: Story = {
    render: (args) => {
        ...
        const handleChange = (currentValue: DropdownCollapsibleValue | undefined) => {
            setDropdownValue(currentValue);
        };
...
export const WithFormTrigger: Story = {
    args: {
        options: DEFAULT_OPTIONS,
        formLabel: "Label",
        trigger: {label: "Label", formTrigger: true, formTriggerSize: DropdownFormTriggerSizes.SMALL},
    },
    decorators: [
        (Story) => {
            const {props} = Story();
...
export const UsingCustomIcons: Story = {
    args: {
        trigger: {label: "Seleccionar Tenant"},
        options: {
            a: {
                label: "Group A",
